...
namespace ComicBookGalleryModel
{
    internal class DatabaseInitializer : DropCreateDatabaseIfModelChanges<Context>
    {
        protected override void Seed(Context context)
        {
            ...
            comicBook1.AddArtists(artistStanLee, roleScript);
            comicBook1.AddArtists(artistSteveDitko, rolePencils);
            ...
            comicBook2.AddArtists(artistStanLee, roleScript);
            comicBook2.AddArtists(artistSteveDitko, rolePencils);
            ...
            comicBook3.AddArtists(artistStanLee, roleScript);
            comicBook3.AddArtists(artistSteveDitko, rolePencils);
            ...
            comicBook4.AddArtists(artistArchieGoodwin, roleScript);
            comicBook4.AddArtists(artistGeneColan, rolePencils);
            ...
            comicBook5.AddArtists(artistArchieGoodwin, roleScript);
            comicBook5.AddArtists(artistJohnnyCraig, rolePencils);
            ...
            comicBook6.AddArtists(artistArchieGoodwin, roleScript);
            comicBook6.AddArtists(artistJohnnyCraig, rolePencils);
            ...
            comicBook7.AddArtists(artistJeffSmith, roleScript);
            comicBook7.AddArtists(artistJeffSmith, rolePencils);
            ...
            comicBook8.AddArtists(artistJeffSmith, roleScript);
            comicBook8.AddArtists(artistJeffSmith, rolePencils);
            ...
            comicBook9.AddArtists(artistJeffSmith, roleScript);
            comicBook9.AddArtists(artistJeffSmith, rolePencils);
